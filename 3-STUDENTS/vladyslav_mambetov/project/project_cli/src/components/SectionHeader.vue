        ...
        <header class="container px-0 my-4">
            <div class="row col-12 d-flex px-0 mx-0">
                ...
                <div class="logo d-flex justify-content-center px-0
                    ...
                    <a @click="$router.push('/')" href="" class="pr-2"><img src="../../src/assets/imgs/logo.png" alt="logo"></a>
                    <a @click="$router.push('/')" href="" class="pr-3 pr-xl-3 pr-lg-0 pr-md-2 pr-sm-2 brand">bran<span>d</span></a>
                </div>
                ...
                <div class="row headerAccountAndCart d-none  align-items-center
                    ...
                    <div class="headerCart pr-4">
                        <!-- <label for="cart_checkbox" class="label_cart_checkbox cursor-pointer"></label>
                        <a href="#"><img src="../../src/assets/imgs/cart.png" alt="headerCart"></a> -->
                        ...
                        <div class="headerCartWrap" v-show="showBasket">
                        ...
                        <div class="headerCartWrap">
                            ...
                            <div class="headerCartWrapInAll">
                                <div class="d-flex headerCartWrapIn">
                                    <a href="#" class="d-flex ">
                                        <img src="../../src/assets/imgs/myAccount1.jpg" alt="">
                                        <div>
                                            <div>Rebox Zane</div>
        ...
        <nav class="nav container d-none d-md-flex justify-content-center mt-3"> 
                ...
                <div class="dropNav">
                    ...
                    <div class="dropNavIn">
                        ...
                        <a href="">
                            <div>Super sale!</div>
                            <img src="../../src/assets/imgs/navDrop.jpg" alt="nav img">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="navAll">
                <a @click="$router.push('/single-page')" class="nav-link" href="" style="color: blue">Single Page</a>
            </div>
            <div class="navAll">
                <a @click="$router.push('/shopping-cart')" class="nav-link" href="" style="color: blue">Shopping Cart</a>
            </div>
            <div class="navAll">
                <a @click="$router.push('/checkout')" class="nav-link" href="" style="color: blue">Checkout</a>
            </div>
            <div class="navAll">
                <a @click="$router.push('/product')" class="nav-link" href="" style="color: blue">Product</a>
            </div>      
